...
public class Ex0_main {
    public static Long ID0=208113381L, ID1 = 206467292L, ID2 = null;
    public static void main(String[] ar) {
       ...
       //  ElevatorAlgo ex0_alg = new FinalAlgo(Simulator_A.getBuilding());    // Shabat Elev with two trick - replace with your code;
